...
<div class="mdui-container-fluid">
	...
	<form action="" method="post">
		...
		<div class="mdui-textfield mdui-textfield-floating-label">
		   <i class="mdui-icon material-icons">&#xe41a;</i>
		   <label class="mdui-textfield-label">非 localhost 网站必须使用https协议</label>
		   <input type="text" class="mdui-textfield-input" name="redirect_uri" required value="<?php echo $redirect_uri;?>"/>
